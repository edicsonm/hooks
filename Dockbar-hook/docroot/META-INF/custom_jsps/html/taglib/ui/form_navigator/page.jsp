...
%>
<%  
	/* System.out.println("portletName: " + portletName + " ---> " + PortletKeys.MY_ACCOUNT); */
%>
				...
				<ul class="form-navigator nav nav-list span4 well">
					...
					%>
							...
							<c:if test="<%= Validator.isNotNull(category) %>">
								<li class="nav-header">
									<%									
									if(portletName.equals(PortletKeys.MY_ACCOUNT) && category.equals("miscellaneous")){
									%>
										<liferay-ui:message key="merchant-information" />
									<%}else{%>
									...
									<a class="tab-label" href="#<%= sectionId %>" id="<%= sectionId %>Link">
										...
										<c:choose>
											<c:when test='<%= displayStyle.equals("steps") %>'>
												...
												<%									
													if(portletName.equals(PortletKeys.MY_ACCOUNT) && section.equals("custom-fields")){
												%>
													<span class="message"><liferay-ui:message key="business-information" /></span>
												<%}else{%>
											...
											<c:otherwise>
												<%									
													if(portletName.equals(PortletKeys.MY_ACCOUNT) && section.equals("custom-fields")){
												%>
													<liferay-ui:message key="business-information" />
												<%}else{%>
