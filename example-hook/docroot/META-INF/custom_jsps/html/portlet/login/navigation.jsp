...
<liferay-util:include page="/html/portlet/login/navigation.jsp" useCustomPage="false"
/>
<p>
This was modified by the Example Application Adapter.
</p> --%>
...
<liferay-util:buffer var="navigation">
	<liferay-ui:icon-list>
		...
		for (String section : PropsValues.LOGIN_FORM_NAVIGATION_PRE) {
			/* System.out.println("section LOGIN_FORM_NAVIGATION_PRE : " + section); */
			if(!section.equalsIgnoreCase("open-id")){
		%>
		...
		for (String section : PropsValues.LOGIN_FORM_NAVIGATION_POST) {
			/* System.out.println("section LOGIN_FORM_NAVIGATION_POST : " + section); */
		%>
